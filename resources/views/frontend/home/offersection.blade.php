            ...
            <div class="relative mt-3">
                ...
                <div class="absolute -top-8 -right-1 md:-right-8 w-32 h-14" style="animation: bounce 3s infinite;">
                    <div class="relative">
                        ...
                        <!-- Success Badge -->
                        <div
                            class="absolute -bottom-2 -right-2 bg-green-500 text-white text-xs font-bold px-2 py-1 rounded-full animate-pulse">
                            ✓ 98%
                        </div>
                    </div>
                </div>
                ...
                {{-- <div class="grid grid-cols-2 gap-4 mt-6">
                    ...
                    <div
                        class="bg-white rounded-lg p-4 text-center shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                        <div class="text-2xl font-bold text-green-600 mb-1 animate-pulse">99%</div>
