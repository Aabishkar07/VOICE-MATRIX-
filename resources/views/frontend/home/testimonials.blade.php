    ...
    <div class="px-10 slide-in-left">
        <div class="flex justify-between gap-x-0 items-center  ">
            <h2 class="max-sm:text-lg  text-2xl  text-primary text-left text-primary md:text-2xl font-semibold ">
                Message From {{ $tesimonials->designation }}
            </h2>
        </div>
        <div class="flex py-4">
    ...
    <div class="grid md:grid-cols-3 items-center gap-12  p-8  transition-shadow duration-300 fade-up">
        ...
        <div class="flex justify-center">
            <div class="relative">
                ...
                <img
                    src="{{ asset('uploads/' . $tesimonials->featured_image ) }}"
        ...
        <div class="md:col-span-2 space-y-6">
            ...
            <div class="relative">
                <p class="text-gray-700 text-lg italic leading-relaxed">
                    {!! $tesimonials->description !!}
                </p>
            </div>

            <!-- Author Information -->
            <div class="mt-8 border-l-4 border-black pl-4">
                <p class="text-gray-900 text-xl font-semibold">{{ $tesimonials->designation }}</p>
                {{-- <p class="text-black text-sm font-medium mt-1">{{ $tesimonials->title }}</p> --}}
            </div>
        </div>
    </div>
</div>
