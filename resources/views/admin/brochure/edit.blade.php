...
@section('body')
    <div class="flex gap-4">
        ...
        <div class="text-xl font-bold">Edit notice</div>
    </div>
    <div class="bg-white rounded-lg shadow-md ">
        <form action="{{ route('admin.brochures.update', $brochures->id) }}" method="POST" class="space-y-6"
            ...
            <div class="p-6 mt-3">
                <div class="flex flex-col ">
                    <div>
                        ...
                        <div>
                            <input
                                ...
                                value="{{ old('title', $brochures->title) }}" />
                            @error('title')
                    ...
                    <div class="mt-3">
                        <label class='text-sm font-semibold'>Brochures Image </label>
                        ...
                        <img class="oldimage" src="{{ asset('/uploads/' . $brochures->image) }}" alt="PDF"
                    ...
                    <div>
                        ...
                        <div>
                            <input
                                ...
                                value="{{ old('order', $brochures->order) }}" />
                            @error('order')
                                <div class="text-sm text-red-400 invalid-feedback" style="display: block;">
                                    * {{ $message }}
                                </div>
