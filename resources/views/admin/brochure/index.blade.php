...
@section('body')
    <div class="w-full bg-background">
        ...
        <div class="flex justify-between">
            <div class="text-2xl font-bold">Brochures</div>
            <div class="text-right "> <a href="{{ route('admin.brochures.create') }} "
        ...
        <div class='p-3 mt-10 bg-white rounded-lg shadow product-table font-main'>
            ...
            <div class="relative overflow-x-auto">
                <table class="w-full divide-y divide-gray-200">
                    ...
                    @foreach ($brochures as $key => $popup)
                            ...
                            <tr>
                                ...
                                <td class="p-2" style="width: 100px;">
                                    ...
                                    @if (in_array(strtolower($extension), $imageExtensions))
                                      ...
                                      <img src="{{ asset('uploads/' . $filename) }}" alt="Certificate" class="object-cover w-full">
                                    @elseif (strtolower($extension) === $pdfExtension)
                                      <!-- If the file is a PDF -->

                                      <iframe src="{{ asset('uploads/' . $filename) }}" width="100%" height="80px" frameborder="0"></iframe>
                                    @else
                                ...
                                <td>
                                    <div class="flex justify-center p-2">
                                        <a href="{{ route('admin.brochures.edit', $popup->id) }}">
                                        ...
                                        <form method="POST" action="{{ route('admin.brochures.destroy', $popup->id) }}"
