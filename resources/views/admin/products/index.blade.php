                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center p-2">
                                            ...
                                            <form method="POST" class="text-black" action="{{ route('admin.updatestatus' , $product->id) }}">
                                                @csrf
                                                @method('POST')

                                                <select name="status" class="rounded-lg border-gray-300 text-sm py-1 px-2">
                                                    <option value="active" {{ $product->status == 'active' ? 'selected' : '' }}>Active</option>
                                                    <option value="inactive" {{ $product->status == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                                </select>
                                                <button type="submit"
                                                    class="ml-2 rounded-lg bg-blue-500 py-1 px-2 text-xs font-bold uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40">
                                                    Update
                                                </button>
                                            </form>
