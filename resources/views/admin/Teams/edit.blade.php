...
@section('body')
    <div class="flex items-center gap-x-4 mb-6">
        ...
        <div class="text-2xl font-bold text-gray-800">Edit Team Member</div>
    </div>
        ...
        <form action="{{ route('admin.teams.update' , $team->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="p-8">
                <div class="space-y-6">
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input class="w-full p-3 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-blue-400 transition-colors" name="name" placeholder="Enter name" type="text" value="{{ old('name', $team->name) }}" />
                                @error('name')
                            ...
                            <div>
                                ...
                                @if ($team->image)
                                    <div class="mt-3">
                                        ...
                                        <img class="oldimage rounded-lg shadow-sm" src="{{ asset('/uploads/' . $team->image) }}" alt="Current Image" style="width: 100px; height: auto;">
                                    </div>
                                @endif

                                <!-- New Image Preview -->
                                <img id="output" class="mt-3 rounded-lg shadow-sm" style="width: 100px; height: auto; display: none;" />
                    ...
                    <!-- Designation Section -->
                    <div class="border-b border-gray-200 pb-6">
                        <h3 class="text-lg font-semibold text-gray-800 mb-4">Role Details</h3>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Designation <span class="text-red-500">*</span></label>
                            <input class="w-full p-3 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-blue-400 transition-colors" name="designation" placeholder="Enter designation" type="text" value="{{ old('designation', $team->designation) }}" />
                            @error('designation')
                                <div class="text-sm text-red-500 mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div>
                            ...
                            <input class="w-full p-3 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-blue-400 transition-colors" name="number" placeholder="Enter contact number" type="text" value="{{ old('number', $team->number) }}" />
                            @error('number')
                                <div class="text-sm text-red-500 mt-1">{{ $message }}</div>
                            @enderror
                        </div>
