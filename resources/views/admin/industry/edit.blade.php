                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">
                                    Industry Title <span class="text-red-500">*</span>
                                </label>
                                <input
                                    ...
                                    name="title" placeholder="Enter industry title here" type="text"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('order', $industry->order) }}" />
                                @error('order')
                                    <div class="text-sm text-red-500 mt-1">
                                        {{ $message }}
                                    </div>
                                ...
                                @if ($industry->image)
                                    <div class="mt-3">
                                        ...
                                        <img class="oldimage rounded-lg shadow-sm"
                                            src="{{ asset('/uploads/' . $industry->image) }}" alt="Current Industry Image"
