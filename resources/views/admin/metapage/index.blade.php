...
@section('body')
    ...
    <div class="flex items-center justify-between mb-8">
        <div class="flex items-center gap-x-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Meta Pages</h1>
                <p class="text-sm text-gray-600">Manage all Metas </p>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($metapages as $key => $metapage)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900">{{ $metapage->meta_title }}</div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900">{{ $metapage->meta_description }}</div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        {{-- <form method="POST" action="{{ route('admin.metapages.destroy', $metapage->id) }}"
                                            id="delete-form-{{ $metapage->id }}" class="inline">
                                            @csrf
                                            @method('delete')
                                            <button type="button" onclick="deleteItem({{ $metapage->id }})"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h3 class="text-lg font-medium text-gray-900 mb-2">No Meta Page found</h3>
