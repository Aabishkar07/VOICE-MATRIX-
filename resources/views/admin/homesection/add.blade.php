...
@section('body')
    <div class="flex items-center gap-x-4 mb-6">
        ...
        <div class="text-2xl font-bold text-gray-800">Add Home Section</div>
    </div>

    <div class="bg-white rounded-xl shadow-lg text-slate-600">
        <form method="post" action="{{ route('admin.homesections.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="p-8">
                <div class="space-y-6">
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <img id="main-output" class="mt-3 rounded-lg shadow-sm" style="width: 100px; height: auto;" />
                                @error('image')
                                    <div class="text-sm text-red-500 mt-1">
                                        {{ $message }}
                                    </div>
                            ...
                            <div>
                                ...
                                <img id="mini-output" class="mt-3 rounded-lg shadow-sm" style="width: 100px; height: auto;" />
                                @error('mini_image')
                                    <div class="text-sm text-red-500 mt-1">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                name="description" rows="6" placeholder="Enter detailed section description...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="text-sm text-red-500 mt-1">
                                    {{ $message }}
                                </div>
