...
@section('body')
    <div class="flex items-center gap-x-4 mb-6">
        <a @if ($service->parent_id != 0) href="{{ route('admin.services.index', ['services' => $service->parent_id]) }}"
           @else href="{{ route('admin.services.index') }}" @endif
        ...
        <div class="text-2xl font-bold text-gray-800">Edit Service</div>
    </div>
        ...
        <form action="{{ route('admin.services.update', $service->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="p-8">
                <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="title" placeholder="Enter service title here" type="text"
                                ...
                                @if ($service->image)
                                    <div class="mt-3">
                                        ...
                                        <img class="oldimage rounded-lg shadow-sm"
                                            src="{{ asset('/uploads/' . $service->image) }}" alt="Current Service Image"
                    ...
                    <input type="hidden" name="services" value="{{ $service->parent_id }}">
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                name="description" rows="6" placeholder="Enter detailed service description...">{{ old('description', $service->description) }}</textarea>
                            @error('description')
                                <div class="text-sm text-red-500 mt-1">
                                    {{ $message }}
                                </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    class="w-full p-3 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-blue-400 transition-colors"
                                    name="meta_description" placeholder="Enter meta description for search engines" rows="3">{{ old('meta_description', $service->meta_description) }}</textarea>
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit"
                            class="px-8 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors">
