...
@section('body')
    <div class="flex items-center gap-x-4 mb-6">
        <a href="{{ route('admin.services.index', ['services' => request('services' ?? 0)]) }}"
        ...
        <div class="text-2xl font-bold text-gray-800">Add New Service</div>
    </div>
        ...
        <form method="post" action="{{ route('admin.services.store') }}" enctype="multipart/form-data">
            ...
            <div class="p-8">
                <div class="space-y-6">
                    ...
                    <input type="hidden" name="parent_id" value="{{ request('services' ?? 0) }}">
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                name="description" rows="6" placeholder="Enter detailed service description...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="text-sm text-red-500 mt-1">
                                    {{ $message }}
                                </div>
