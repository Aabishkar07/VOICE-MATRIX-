                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($banners as $key => $banner)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <img class="w-20 h-14 object-cover rounded-lg border border-gray-200 shadow-sm" src="{{ asset('uploads/' . $banner->image) }}" alt="{{ $banner->title }}">
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.banner.destroy', $banner->id) }}" id="delete-form-{{ $banner->id }}" class="inline">
                                        @csrf
                                        @method('delete')
