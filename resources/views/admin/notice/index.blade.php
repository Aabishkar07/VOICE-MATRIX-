...
@section('body')
    <div class="w-full bg-background">
        ...
        <div class="flex justify-between">
            <div class="text-2xl font-bold">Notice</div>
            <div class="text-right "> <a href="{{ route('admin.notice.create') }} "
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex justify-center p-2">
                                        <a href="{{ route('admin.notice.edit', $popup->id) }}">
                                        ...
                                        <form method="POST" action="{{ route('admin.notice.destroy', $popup->id) }}"
