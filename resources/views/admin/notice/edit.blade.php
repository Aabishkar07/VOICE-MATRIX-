...
@section('body')
    ...
    <div class="bg-white rounded-lg shadow-md ">
        <form action="{{ route('admin.notice.update', $notice->id) }}" method="POST" class="space-y-6"
            ...
            <div class="p-6 mt-3">
                <div class="flex flex-col ">
                    ...
                    <div class="mt-3">
                        <label class='text-sm font-semibold'>Notice Image or PDF</label>
                        ...
                        <img class="oldimage" src="{{ asset('/uploads/' . $notice->image) }}" alt="PDF"
